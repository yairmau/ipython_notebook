...
ax.text(2.0,0.2,r'$\xrightarrow[\text{smaller percolation events}]{}$',ha='center',va='center')
ax.text(0.2,2.5,r'$\xrightarrow[]{\text{more frequent percolation events}}$',ha='center',va='center',rotation=90)
